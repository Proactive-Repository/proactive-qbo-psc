        ...
        lines: {
          ...
          items: {
            ...
            properties: {
              ...
              tax_code: { type: "string", description: "Tax code id or name from list_tax_codes. Required on Canadian files; omit on US files (PGU, PLX) — US sales tax is included in the line amount or entered as its own line." },
            },
